...
import type { CreateEpicRequest, EpicType, Priority, MocksStatus } from '../../types';

interface CreateEpicFormProps {
  onSubmit: (data: CreateEpicRequest) => Promise<void>;
  onCancel: () => void;
  isLoading?: boolean;
  initialData?: Partial<CreateEpicRequest>;
}

const EPIC_TYPE_OPTIONS: { value: EpicType; label: string }[] = [
...
export const CreateEpicForm: React.FC<CreateEpicFormProps> = ({
  onSubmit,
  onCancel,
  isLoading = false,
  initialData = {},
